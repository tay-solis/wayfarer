    ...
    render(){
        return(
            <form  encType="multipart/form-data"  id="signupForm" onSubmit={this.onFormSubmit}>
                ...
                <input type="text" required placeholder="First Name"  name="firstName" onChange={this.handleInputChange}/>
                <input type="text" required placeholder="Last Name"  name="lastName" onChange={this.handleInputChange}/>
                <input type="email" required placeholder="Email"  name="email" onChange={this.handleInputChange}/>
                <input type="text" required placeholder="Username"  name="username" onChange={this.handleInputChange}/>
                <input type="password" required placeholder="Password"  name="password1" onChange={this.handleInputChange}/>
                <input type="password" required placeholder="Re-enter Password"  name="password2" onChange={this.handleInputChange}/>
                <input type="text" required placeholder="Your City" name="city" onChange={this.handleInputChange}/>
